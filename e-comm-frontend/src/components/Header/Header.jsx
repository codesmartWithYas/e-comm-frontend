...
const Header = () => {
  ...
  return (
    ...
    <header className="border-b border-gray-300 sticky top-0 z-20 bg-grey-100">

        <div className="flex items-center justify-between mx-auto max-w-[1152px] px-6 py-4">
            <a href="/" className="text-center text-lg font-primary font-semibold text-primary py-2"> 
            <FontAwesomeIcon icon={faTags} className="h-8 w-8"/>
            <span className='font-bold'>Shop Hub</span>
            </a>
            <nav className="flex items-center py-2 z-10">
                <ul className="flex space-x-6">
                    <li className="text-sm font-primary font-semibold text-dark">
